...
## infra · Rule · GCP firewall is the actual port boundary — nginx alone does not close ports
...
## infra · Rule · Every process on a GCP VM inherits the SA permissions automatically
> 2026-04-19 · source: pea-pme-pulse
