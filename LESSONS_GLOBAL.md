...
- `~/.claude/lessons/LESSONS_DOCKER.md` — Docker Compose, Dockerfile, docker cp, systemd conflicts, container lifecycle
- `~/.claude/lessons/LESSONS_INFRA.md` — server ops, Terraform, cron, SSH, launchd, Nextcloud rsync, shell env vars
