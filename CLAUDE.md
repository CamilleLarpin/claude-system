...
## Global Knowledge — load on demand (read file when trigger applies, do not auto-load) · exception: CONTEXT_GLOBAL.md always loaded — keep minimal
- `@~/.claude/CONTEXT_GLOBAL.md` — what is true now: stack, live services, architecture, philosophy
